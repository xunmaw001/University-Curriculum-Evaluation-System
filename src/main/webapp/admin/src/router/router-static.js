...
import center from '@/views/center'
    import zhuanjiapingjia from '@/views/modules/zhuanjiapingjia/list'
    ...
    import zhibiaoxinxi from '@/views/modules/zhibiaoxinxi/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/zhuanjiapingjia',
        name: '专家评价',
        component: zhuanjiapingjia
      }
      ,{
