<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="指标号" prop="zhibiaohao">
            <el-input v-model="ruleForm.zhibiaohao" 
                placeholder="指标号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhibiaohao" label="指标号" prop="zhibiaohao">
              <el-input v-model="ruleForm.zhibiaohao" 
                placeholder="指标号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指标名称" prop="zhibiaomingcheng">
          <el-input v-model="ruleForm.zhibiaomingcheng" 
              placeholder="指标名称" clearable  :readonly="ro.zhibiaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指标名称" prop="zhibiaomingcheng">
              <el-input v-model="ruleForm.zhibiaomingcheng" 
                placeholder="指标名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指标权重" prop="zhibiaoquanzhong">
          <el-input v-model="ruleForm.zhibiaoquanzhong" 
              placeholder="指标权重" clearable  :readonly="ro.zhibiaoquanzhong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指标权重" prop="zhibiaoquanzhong">
              <el-input v-model="ruleForm.zhibiaoquanzhong" 
                placeholder="指标权重" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="指标内容" prop="zhibiaoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="指标内容"
                  v-model="ruleForm.zhibiaoneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhibiaoneirong" label="指标内容" prop="zhibiaoneirong">
                    <span>{{ruleForm.zhibiaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      ro:{
	zhibiaohao : false,
	zhibiaomingcheng : false,
	zhibiaoquanzhong : false,
	zhibiaoneirong : false,
      },
      ruleForm: {
        zhibiaohao: this.getUUID(),
        zhibiaomingcheng: '',
        zhibiaoquanzhong: '',
        zhibiaoneirong: '',
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhibiaohao'){
            this.ruleForm.zhibiaohao = obj[o];
	    this.ro.zhibiaohao = true;
            continue;
          }
          if(o=='zhibiaomingcheng'){
            this.ruleForm.zhibiaomingcheng = obj[o];
	    this.ro.zhibiaomingcheng = true;
            continue;
          }
          if(o=='zhibiaoquanzhong'){
            this.ruleForm.zhibiaoquanzhong = obj[o];
	    this.ro.zhibiaoquanzhong = true;
            continue;
          }
          if(o=='zhibiaoneirong'){
            this.ruleForm.zhibiaoneirong = obj[o];
	    this.ro.zhibiaoneirong = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhibiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhibiaoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
