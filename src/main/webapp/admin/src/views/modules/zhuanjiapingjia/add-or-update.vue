<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学能力" prop="jiaoxuenengli">
          <el-select :disabled="ro.jiaoxuenengli" v-model="ruleForm.jiaoxuenengli" placeholder="请选择教学能力">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教学能力" prop="jiaoxuenengli">
	      <el-input v-model="ruleForm.jiaoxuenengli"
                placeholder="教学能力" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学效果" prop="jiaoxuexiaoguo">
          <el-select :disabled="ro.jiaoxuexiaoguo" v-model="ruleForm.jiaoxuexiaoguo" placeholder="请选择教学效果">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教学效果" prop="jiaoxuexiaoguo">
	      <el-input v-model="ruleForm.jiaoxuexiaoguo"
                placeholder="教学效果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学生状态" prop="xueshengzhuangtai">
          <el-select :disabled="ro.xueshengzhuangtai" v-model="ruleForm.xueshengzhuangtai" placeholder="请选择学生状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="学生状态" prop="xueshengzhuangtai">
	      <el-input v-model="ruleForm.xueshengzhuangtai"
                placeholder="学生状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学评分" prop="jiaoxuepingfen">
          <el-input v-model="ruleForm.jiaoxuepingfen" 
              placeholder="教学评分" clearable  :readonly="ro.jiaoxuepingfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学评分" prop="jiaoxuepingfen">
              <el-input v-model="ruleForm.jiaoxuepingfen" 
                placeholder="教学评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学评级" prop="jiaoxuepingji">
          <el-select :disabled="ro.jiaoxuepingji" v-model="ruleForm.jiaoxuepingji" placeholder="请选择教学评级">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教学评级" prop="jiaoxuepingji">
	      <el-input v-model="ruleForm.jiaoxuepingji"
                placeholder="教学评级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专家账号" prop="zhuanjiazhanghao">
          <el-input v-model="ruleForm.zhuanjiazhanghao" 
              placeholder="专家账号" clearable  :readonly="ro.zhuanjiazhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专家账号" prop="zhuanjiazhanghao">
              <el-input v-model="ruleForm.zhuanjiazhanghao" 
                placeholder="专家账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	xueshengzhuangtai : false,
	jiaoxuepingfen : false,
	jiaoxuepingji : false,
	...
	crossrefid : false,
      ...
      ruleForm: {
        ...
        crossrefid: '',
          ...
          jiaoxuenengliOptions: [],
          jiaoxuexiaoguoOptions: [],
          xueshengzhuangtaiOptions: [],
          jiaoxuepingjiOptions: [],
      rules: {
          kecheng: [
          ],
          jiaoxuenengli: [
                { required: true, message: '教学能力不能为空', trigger: 'blur' },
          ],
          jiaoxuexiaoguo: [
                { required: true, message: '教学效果不能为空', trigger: 'blur' },
          ],
          xueshengzhuangtai: [
                { required: true, message: '学生状态不能为空', trigger: 'blur' },
          ],
          jiaoxuepingfen: [
                { required: true, message: '教学评分不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          jiaoxuepingji: [
                { required: true, message: '教学评级不能为空', trigger: 'blur' },
          ],
          pingjianeirong: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kecheng = true;
          ...
          if(o=='jiaoxuenengli'){
            this.ruleForm.jiaoxuenengli = obj[o];
	    this.ro.jiaoxuenengli = true;
            continue;
          }
          if(o=='jiaoxuexiaoguo'){
	    ...
	    this.ro.jiaoxuexiaoguo = true;
          ...
          if(o=='xueshengzhuangtai'){
            this.ruleForm.xueshengzhuangtai = obj[o];
	    this.ro.xueshengzhuangtai = true;
            continue;
          }
          if(o=='jiaoxuepingfen'){
            this.ruleForm.jiaoxuepingfen = obj[o];
	    this.ro.jiaoxuepingfen = true;
            continue;
          }
          if(o=='jiaoxuepingji'){
            this.ruleForm.jiaoxuepingji = obj[o];
	    this.ro.jiaoxuepingji = true;
            continue;
          }
          if(o=='pingjianeirong'){
      ...
      this.$http({
		...
		if(json.zhuanjiazhanghao!=''&&json.zhuanjiazhanghao){
                this.ruleForm.zhuanjiazhanghao = json.zhuanjiazhanghao
	    		this.ro.zhuanjiazhanghao = true;
		}
		if(json.zhuanjiaxingming!=''&&json.zhuanjiaxingming){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhuanjiapingjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhuanjiapingjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
